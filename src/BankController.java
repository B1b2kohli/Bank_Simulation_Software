...
public class BankController
{
    ...
    {
        Scanner sc=new Scanner(System.in);//for input support1
        ...
        try
        {
            ...
            table.add(new User(14523698,"Bittu kohli",1289,50000000));
            ...
            table.add(new User(99676898,"Ellon musk",1234,0));
            table.add(new User(141212455,"Alex Morton",1279,5800000));
